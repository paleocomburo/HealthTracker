...
public partial class BloodSugarView : UserControl
{
    private BloodSugarViewModel? _vm;
    ...
    public BloodSugarView()
    {
        ...
        DataContextChanged += async (_, _) =>
        {
            ...
            _vm = DataContext as BloodSugarViewModel;
    ...
    {
        if (e.PropertyName != nameof(BloodSugarViewModel.PlotVersion) || _vm is null) return;
