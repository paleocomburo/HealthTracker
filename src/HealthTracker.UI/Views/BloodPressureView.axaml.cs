...
{
    private BloodPressureViewModel? _vm;
    ...
    public BloodPressureView()
    {
        ...
        DataContextChanged += async (_, _) =>
        {
            ...
            _vm = DataContext as BloodPressureViewModel;
    ...
    {
        if (e.PropertyName != nameof(BloodPressureViewModel.PlotVersion) || _vm is null) return;
